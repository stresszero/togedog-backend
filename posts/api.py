...
@router.get("/deleted/{post_id}/", response={200: AdminGetDeletedPostOut})
...
def get_post(request, post_id: int):
    ...
    post = get_object_or_404(Post.objects.select_related('user') \
        .prefetch_related('likes'), id=post_id, is_deleted=False)
...
@router.patch("/{post_id}", response={200: MessageOut, 400: MessageOut})
...
@router.get("/{post_id}/admin/", response={200: AdminGetPostOut})
...
@router.post("/{post_id}/delete/", response={200: MessageOut})
...
@router.post("/{post_id}/report/", response={200: MessageOut})
...
@router.delete("/{post_id}/delete/hard", response={200: MessageOut})
...
@router.post("/{post_id}/likes", response={200: MessageOut, 404: MessageOut})
...
@router.post("", response={200: MessageOut, 400: MessageOut})
